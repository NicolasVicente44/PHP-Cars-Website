...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
    <div class="container-fluid">
        ...
        <a class="navbar-brand" href="<?= ROOT_PATH ?>/about">
           About
        </a>
        <a class="navbar-brand" href="<?= ROOT_PATH ?>/contact">
            Contact Us
        </a>
        <nav>
                ...
                <?php if ($auth): ?>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="<?= ROOT_PATH ?>/options/new">New</a></li>
                            <li><a class="dropdown-item" href="<?= ROOT_PATH ?>/options">List</a></li>
                        </ul>
